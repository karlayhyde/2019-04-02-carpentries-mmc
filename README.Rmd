...
This is the github repository for our paper titled <My First Attempt at R Studio Cloud>. Please make use of our work, and if you do, please cite as follows:

>  Hyde, Karla. "<My First Attempt at R Studio Cloud>". *<JOURNAL TITLE>* <VOLUME>, no. <NUMBER> (<YEAR>): <PAGES>. doi: https://dx.doi.org/xxxxxx.
